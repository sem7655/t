...
while True:
    ...
    # Вывести сообщение о непонимании кода IDE в Telegram
    ...
    print(
        "Вот ссылка, где можно удобно писать код онлайн: https://www.programiz.com/python-programming/online-compiler/")
else:
